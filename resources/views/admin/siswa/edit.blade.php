...
@section('content')
    ...
    <form method="POST" action="{{ route('admin.siswa.update', $siswa->id) }}" class="form-card" id="formSiswa">
        @csrf @method('PUT')
        ...
        <div class="form-group">
            ...
            <input name="nama_anak" value="{{ $siswa->nama_anak }}" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input name="no_induk" value="{{ $siswa->no_induk }}">
        </div>
        ...
        <div class="form-group">
            ...
            <input name="nama_orangtua" value="{{ $siswa->nama_orangtua }}" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input name="wa" value="{{ $siswa->wa }}" required>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="keterangan" rows="3">{{ $siswa->keterangan }}</textarea>
        </div>
