...
@section('content')
    ...
    <form class="form-card" method="POST" action="{{ route('admin.invoice.store') }}" id="formInvoice">
        @csrf
        ...
        <div class="form-group">
            ...
            <select name="siswa_id" required>
                ...
                @foreach ($siswas as $siswa)
                    <option value="{{ $siswa->id }}">{{ $siswa->nama_anak }}</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" name="nominal" required placeholder="Masukkan nominal">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="periode" placeholder="Contoh: 2025-01">
        </div>
